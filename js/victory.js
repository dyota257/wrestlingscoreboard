...
5 points for the winner and 0 for the loser:
    - Victory by fall (with or without technical point for the loser) (VFA 5:0)
    - Injury (VIN 5:0)
...
4 points for the winner and 0 for the loser (VSU 4:0):
    - Victory by technical superiority (8 points difference in Greco-Roman style and 10 points in Freestyle during the bout), with the loser scoring no technical points

4 points for the winner and 1 point for the loser (VSU1 4:1):
    - Victory by technical superiority during the bout with loser scoring technical points.

3 points for the winner and 0 for the loser (VPO 3:0):
    - When the wrestler wins at the end of the two periods by 1 to 7 points in Greco Roman style and 1 to 9 points in Freestyle with the loser scoring no point.
